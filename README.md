...
## About The Project
A crowd funding Dapp is being developed for this project. The purpose of this project is to demonstrate that anyone can send Ether to this contract, but only the owner can withdraw it. This Dapp is designed in such a way that funders are required to send at least 20 dollars.
